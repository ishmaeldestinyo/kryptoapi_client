      ...
      <main>
        <div className='md:flex md:w-4/5 gap-5 md:gap-6 md:p-12 p-6 mx-auto'>
          ...
          <div className='md:w-3/5'>
            ...
            <h3 className='text-sm md:text-base mt-3'>An Optimized crypto API engine offering a comprehensive suite of services, including fraud detection, wallet-as-a-service, and payment-as-a-service.</h3>
        ...
        <div className='md:w-4/5 md:mt-12 mx-auto gap-5 md:p-0 p-5  md:grid grid-cols-12'>
          {
            coreServices.map((service, key) => (
              <div className={`col-span-4 shadow-sm p-4 md:mt-0 ${key <= 1 ? 'mt-3': 'mt-5'} flex flex-col relative group transition-transform duration-300 hover:scale-105`} key={key}>
                <div className='relative h-48 w-full'>
                  ...
                  />
                  {/* Button container */}
                  <div className='absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gray-800 bg-opacity-50 rounded-3xl'>
                    <a href="/api-docs" className="text-white font-semibold py-2 px-4 rounded bg-blue-600 hover:bg-blue-700 transition duration-200">
                      View API Docs
                    </a>
                  </div>
                </div>
        ...
        <div className='md:mt-12 md:w-4/5 mx-auto md:p-0 p-5 '>
